...
(unless (is-android)
  ...
  (use-package all-the-icons-dired
    ...
    :config
    (set-face-attribute 'all-the-icons-dired-dir-face nil :inherit 'dired-directory :foreground "#FDFD96" :background 'unspecified))
...
(use-package diredfl
  ...
  (set-face-attribute 'diredfl-dir-priv nil :inherit 'font-lock-keyword-face :background 'unspecified :foreground 'unspecified)
  ...
  (set-face-attribute 'diredfl-dir-name nil :inherit 'dired-directory :foreground "#FDFD96" :background 'unspecified)
