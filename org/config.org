...
(use-package general
  ...
  (leader-key
    "m" '(:ignore t :wk "move")
    "m p" `(,(my-def-rep-command my-line-move-repeat-cmds "p")
            :wk "Move line/region up (p/n to repeat, q to quit)")
    "m n" `(,(my-def-rep-command my-line-move-repeat-cmds "n")
            :wk "Move line/region down (p/n to repeat, q to quit)")))
#+end_src
** Global
#+begin_src emacs-lisp :tangle ~/.emacs.d/config.el
